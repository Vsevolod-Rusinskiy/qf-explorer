    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm">
        ...
        <div className="border rounded p-6 bg-gray-50">
          <h2 className="text-2xl font-semibold mb-4">Статистика сети</h2>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="border rounded p-3 bg-white">
              <div className="text-sm text-gray-500">Последний блок</div>
              <div className="font-mono text-lg">{loading ? '...' : '0'}</div>
            </div>
            <div className="border rounded p-3 bg-white">
            ...
            <div className="border rounded p-3 bg-white">
              ...
              <div className="font-mono text-lg">{loading ? '...' : '0.1s'}</div>
            </div>
          </div>
        </div>
      </div>
