...
В текущей версии MVP предусмотрено ручное обновление данных (через перезагрузку страницы). Это решение выбрано для упрощения первоначальной реализации, но учитывает описанные выше проблемы обработки блокчейн-данных.
